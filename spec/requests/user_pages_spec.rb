...
describe "User pages" do
  ...
  describe "index" do
    ...
    it { page.should have_title('All users') }
    ...
    describe "delete links" do
      ...
      it { page.should_not have_link('delete') }
      ...
      describe "as an admin user" do
        ...
        it { page.should have_link('delete', href: user_path(user)) }
        it "should be able to delete another user" do
          expect do
            click_link('delete', match: :first)
          end.to change(User, :count).by(-1)
        end
        it { page.should_not have_link('delete', href: user_path(admin)) }
      end
    end
  end
  ...
  describe "signup page" do
    ...
    describe "with valid information" do
      ...
      describe "after saving the user" do
        ...
        it { page.should have_selector('div.alert.alert-success', text: 'Welcome') }
      end
    end
  end
